...
// A continuous stream of moving, spinning particles is exactly the kind of
// motion prefers-reduced-motion exists to suppress, and no amount of CSS on
// the spawned spans stops JS from spawning them — so the listener itself
// never attaches when the user has asked for reduced motion.
